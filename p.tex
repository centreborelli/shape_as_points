...
\begin{frame}
OBJECTIF : RECONSTRUCTION D'UNE SURFACE À PARTIR DE POINTS
==========================================================

\begin{tabular}{cc}
	\includegraphics[width=0.4\linewidth]{f/jkdots.png} &
	\includegraphics[width=0.4\linewidth]{f/jkpois.png} \\
